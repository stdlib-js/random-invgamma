...
interface RandomFunction extends PRNG {
	/**
	* Returns an ndarray containing pseudorandom numbers drawn from an inverse gamma distribution.
	*
	...
	*/
	...
	/**
	* Fills an ndarray with pseudorandom numbers drawn from an inverse gamma distribution.
	*
	* @param alpha - shape parameter
	* @param beta - scale parameter
...
interface Random extends PRNG {
	...
	*/
	...
	/**
	* Returns a function for creating ndarrays containing pseudorandom numbers drawn from an inverse gamma distribution.
	*
	* @param options - function options
